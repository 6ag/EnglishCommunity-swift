...
public class FFLabel: UILabel {
    ...
    public var linkTextColor = UIColor(red:0.00, green:0.36, blue:0.62, alpha:1.00)
    public var selectedBackgroudColor = UIColor(red:0.73, green:0.78, blue:0.85, alpha:1.00)
