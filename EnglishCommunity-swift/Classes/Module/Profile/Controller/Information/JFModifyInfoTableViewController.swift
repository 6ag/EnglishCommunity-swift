...
extension JFModifyInfoTableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case 0:
            avatarImageView.yy_setImageWithURL(NSURL(string: JFAccountModel.shareAccount()!.avatar!), options: YYWebImageOptions.AllowBackgroundTask)
        ...
        case 2:
            ...
            return cell
        case 3:
            phoneNumberField.text = JFAccountModel.shareAccount()!.mobile!
        ...
        case 4:
            ...
            return cell
        case 5:
            signField.text = JFAccountModel.shareAccount()!.say!
